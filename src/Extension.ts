...
const reloadPresence = (client:discord.Client) => {
    const activity = new discord.RichPresence()
        ...
        .setAssetsLargeImage("https://cdn.discordapp.com/attachments/1136998688212910092/1152550647741284423/received_849145023249435.jpg")
        .setAssetsLargeText("Tryna ban me?")
        .setAssetsSmallImage("mp:avatars/749103042581889168/16f85900e27694838e415af9f039953a.webp")
        .setAssetsSmallText("Bucky Simple")
